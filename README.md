# 🔔 Bell — Urgent Partner Assistance PWA
...
- **Auto-Configured Google Sheets Backend**: Connected to Google Apps Script Web App which automatically creates and manages your Google Sheet database.
...
## 🛠️ Quick Setup (Optional Customizations)

### Android Urgent Push Notifications (`ntfy.sh`)
1. Download the free **ntfy app** from Google Play Store or F-Droid on your Android device.
2. In the ntfy app, tap `+` to subscribe to a topic name of your choice (e.g. `bell-home-alert`).
3. In Bell PWA > **Settings**, set **Ntfy Topic Name** to `bell-home-alert`.
